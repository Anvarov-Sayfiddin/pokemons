...
let titleElement1 = document.createElement("h1");
let titleElement2 = document.createElement("h2");
titleElement2.className = 'visually-hidden';
titleElement1.className = 'visually-hidden';
elBody.append(titleElement1, titleElement2);
titleElement1.textContent = "pokemon";
titleElement2.textContent = "pokemon";
...
for(let  i = 0; i < pokemons.length;i++) {
	...
	WeightElement.className = 'pokemon-width';
	HeightElement.className = 'pokemon-height';
	EggElement.className = 'pokemon-egg';
	


	ImgElement.src = pokemons[i].img;
	titleElement.textContent = pokemons[i].name;
	WeightElement.textContent ="Weight: " + pokemons[i].weight;
	HeightElement.textContent = "Height: " + pokemons[i].height;
	...
	liElement.appendChild(whWrapper);
	ImgWrapper.appendChild(ImgElement);
	elList.appendChild(liElement);
	whWrapper.append(WeightElement, HeightElement, EggElement);
}